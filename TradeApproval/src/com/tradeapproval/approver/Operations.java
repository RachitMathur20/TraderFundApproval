...
public class Operations implements Approver,Callable<Object> {
	...
	public Operations(TradeRequest tradeRequest) {
	...
	public boolean isApproved() {
		...
		LOGGER.log(Level.INFO, "Waiting for Operations Approval... ");
		

		for (int i = 0; i < 5; i++) {
			try {
				System.out.println("Waiting for Operations Approval... ");
				Thread.sleep(500);
		...
		LOGGER.log(Level.INFO, "Wait ended for Operations Approval");
		System.out.println("Wait ended for Operations Approval");
